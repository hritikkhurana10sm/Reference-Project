...
public class JwtUtil {
    ...
    private String secretKey = "try-not-to-decode";
    ...
    public String getToken(HttpServletRequest httpRequest) {
        String requestHeader = httpRequest.getHeader(Constants.AUTHORIZATION);
    ...
    public Boolean validateToken(String token) {
        try {
            ...
            throw new AuthException(Constants.INVALID_TOKEN_MESSAGE, HttpStatus.UNAUTHORIZED);
        }
    }
}
